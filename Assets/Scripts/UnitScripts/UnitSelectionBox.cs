...
public class UnitSelectionBox : MonoBehaviour
{
    ...
    void SelectUnits()
    {
        foreach (var birim in UnitSelectionManager.Instance.allUnitsList)
        {
            if (selectionBox.Contains(myCam.WorldToScreenPoint(birim.transform.position)))
            {
                UnitSelectionManager.Instance.DragSelect(birim);
            }
        }
    }
}